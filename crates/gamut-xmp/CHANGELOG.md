...
- Decode UTF-16 and UTF-32 XMP packets and expose encoding-aware packet, namespace, and property
  source spans.
- Add an encoding- and envelope-preserving `XmpEdit` transaction for typed property mutations.

### Fixed

- Reject duplicate top-level expanded property names with locations instead of replacing them.
